...
export function ContactCard(props){
    ...
    return (
        <>
        <div className={`user_contact ${phones.item == props.index ? 'active' : ''}`} ref={contact} onClick={()=>{
            console.log('click')
            phones.chooseItem({
                type:"choose",
                payload: props.index
        ...
        <div className="contact_info contact_enum">
          <div className="conatact_info_name">{props.item}</div>
          <div className="contact_info_lastvisit">
            данные о контакте
          </div>
        </div>
      </div>
